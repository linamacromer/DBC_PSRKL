...
Match.create( :competitor1_id => competitor1.id, :competitor2_id => competitor2, :start_time => time1, :season => 1 )
Match.create( :competitor1_id => competitor3.id, :competitor2_id => competitor4, :start_time => time2, :season => 1 )
Match.create( :competitor1_id => competitor5.id, :competitor2_id => competitor6, :start_time => time3, :season => 1 )
Match.create( :competitor1_id => competitor7.id, :competitor2_id => competitor8, :start_time => time4, :season => 1 )
Match.create( :competitor1_id => competitor1.id, :competitor2_id => competitor6, :start_time => time5, :season => 1 )
Match.create( :competitor1_id => competitor6.id, :competitor2_id => competitor8, :start_time => time6, :season => 1 )
