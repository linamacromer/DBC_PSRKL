...
competitor9 = Competitor.create( :name => "Isabella Swan" )
competitor10 = Competitor.create( :name => "Ariana Grande" )
competitor11 = Competitor.create( :name => "Kiara Williams" )
...
Match.create( :competitor1_id => competitor6.id, :competitor2_id => competitor2.id, :start_time => time7, :season => 1, :location => "Basketball Court", :winner_id => competitor6.id, :loser_id => competitor2.id )
Match.create( :competitor1_id => competitor9.id, :competitor2_id => competitor3.id, :start_time => time8, :season => 1, :location => "Basketball Court", :winner_id => competitor9.id, :loser_id => competitor3.id )
